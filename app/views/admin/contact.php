...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=BASEURL;?>/admin/contact" class="nav-link active">
 ...
 <div class="container">
  ...
  <div class="row">
    <div class="col-md-3">
      <h5 style="font-style: italic;">halaman Contact</h5>
    </div>
  </div>
  ...
  <div class="row mt-3">
    <div class="card text-white bg-info mb-5 ml-5" style="max-width: 18rem; min-width: 18rem;">
        <a href="#modal_alamat" data-toggle="modal"><div class="card-header text-bold text-center">UBAH ALAMAT</div></a>
        <div class="card-body">
        <h5 class="card-title">ALAMAT</h5>
        <br>
          <P><?=$pars['kontak']['alamat'];?></P>
          <br>
     ...
     <div class="card text-white bg-success mb-5 ml-5" style="max-width: 18rem; min-width: 18rem;">
        <a href="#modal_telepon" data-toggle="modal"><div class="card-header text-bold text-center">UBAH TELEPON</div></a>
        <div class="card-body">
        <h5 class="card-title">NO.TELEPON</h5>
        <br>
          <P><?=$pars['kontak']['telepon'];?></P>
          <br>
        <h5 class="card-title">KETERANGAN</h5>
        <br>
     ...
     <div class="card text-white bg-secondary mb-5 ml-5" style="max-width: 18rem; min-width: 18rem;">
        <a href="#modal_email" data-toggle="modal"><div class="card-header text-bold text-center">UBAH EMAIL</div></a>
        <div class="card-body">
        <h5 class="card-title">EMAIL</h5>
        <br>
          <P><?=$pars['kontak']['email'];?></P>
          <br>
        <h5 class="card-title">KETERANGAN</h5>
        <br>
...
<!-- kumpulan modal -->
    <!-- Modal telepon -->
<div class="modal fade" id="modal_telepon" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ubah Telepon</h5>
      ...
      <form action="" method="post">        
        <div class="modal-body">
         ...
         <input class="form-control" type="text" name="telepon" value="<?=$pars['kontak']['telepon'];?>">
         <label>KETERANGAN</label>
         <input class="form-control" type="text" name="ket_tlp" value="<?=$pars['kontak']['small_telepon'];?>">
...
<!-- akhir modal telepon -->
 ...
 <!-- Modal modal alamat -->
<div class="modal fade" id="modal_alamat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="" method="post">        
        <div class="modal-body">
         ...
         <label>ALAMAT</label>
         <input class="form-control" type="text" name="alamat" value="<?=$pars['kontak']['alamat'];?>">
         <label>KETERANGAN</label>
         <input class="form-control" type="text" name="ket_alt" value="<?=$pars['kontak']['small_alamat'];?>">
    ...
    <div class="modal-content">
      ...
      <form action="" method="post">        
        <div class="modal-body">
         ...
         <label>EMAIL</label>
         <input class="form-control" type="text" name="email" value="<?=$pars['kontak']['email'];?>">
         <label>KETERANGAN</label>
         <input class="form-control" type="text" name="ket_eml" value="<?=$pars['kontak']['small_email'];?>">
