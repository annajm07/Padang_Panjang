...
<div class="wrapper">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?=BASEURL;?>/admin/about" class="nav-link active">
 ...
 <div class="container">
  ...
  <div class="row">
    <div class="col-md-3">
      <h5 style="font-style: italic;">halaman About</h5>
    </div>
  </div>
  ...
  <div class="row mt-3">
    <div class="col-lg-5">
       <div class="card text-white bg-info mb-5 ml-5" style="max-width: 40rem; min-width: 35rem;">
        <a href="#modal_about" data-toggle="modal"><div class="card-header text-bold text-center">UBAH ABOUT</div></a>
        <div class="card-body">
        <h5 class="card-title text-bold">ABOUT</h5>
        <br>
        <p><?=$pars['about']['deskripsi'];?></p>
        </div>
     </div>
    </div>
  </div>  
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ubah About</h5>
      ...
      <form action="" method="post">        
        <div class="modal-body">
         ...
         <textarea class="form-control" rows="6" cols="100" name="about"><?=$pars['about']['deskripsi']; ?></textarea>
