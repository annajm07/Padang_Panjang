...
<div class="wrapper">
 ...
 <div class="container">
  <div class="row">
    <div class="col-md-3">
      <h5 style="font-style: italic;">halaman Skill</h5>
    </div>
  </div>
  ...
  <div class="row mt-3">
    <div class="col-lg-3 m-auto">
      <a class="btn btn-primary" href="#modal_tambah" data-toggle="modal" >Tambah  <i class="nav-icon fas fa-plus-circle"></i></a>
    </div>
  ...
  <div class="col-lg-11 m-auto">
      <div class="table-responsive">
              <table class="table">
                  ...
                  <tbody>
                    <?php $i= 1; foreach($pars['home'] as $skill) :?>
                    <tr>
                      <th scope="row"><?=$i++; ?></th>
                      <td><?=$skill['keahlian'];?></td>
                      <td><img width="40px" src="<?=BASEURL;?>/img/pekerjaan/<?=$skill['gambar'];?>"></td>
                      <td><?=$skill['detail_keahlian'];?></td>
                      <td>
                        <a class="badge badge-danger" href="<?=BASEURL;?>/admin/hapus/<?=$skill['id'];?>" onclick="return confirm('Apakah anda yakin ingin menghapus ?');">hapus</a>
                        <a class="badge badge-success" href="<?=BASEURL;?>/admin/ubah/<?=$skill['id'];?>">ubah</a>
                      </td>
                    </tr>
                  <?php endforeach; ?>                
                  </tbody>
    ...
    <div class="modal-content ">
      ...
      <form action="" method="post" enctype="multipart/form-data"> 
          ...
          <div class="modal-body">
            ...
            <textarea class="form-control" rows="6" cols="100" name="deskripsi"></textarea>
             </div>
